...
export const videoCallStyle = {
  height: "auto", // recent Automatically adjust height based on the content inside //height: "85vh", // Slightly reduced for better proportion
  ...
  backgroundColor: "rgba(255, 255, 255, 0.5)", // Semi-transparent white for light theme
  ...
  overflowY: "auto", // added recently // Allows scrolling if content exceeds container height
} as CSSProperties
